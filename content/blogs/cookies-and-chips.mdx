...
If you’ve heard “cookies are sent with every request,” that’s only partly true. Cookies are sent _only when they meet certain conditions_, and those conditions come from the properties set on the cookie.
